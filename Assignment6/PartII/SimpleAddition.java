...
public class SimpleAddition extends JFrame {
    ...
    public JPanel createContentPane() {
        ...
        /*
         * any change in the addend fields is an event. add an event listener that will
         * recalculate the sum any time a
         * change occurs in either addend field.
         * Your assignment is to add action listeners that will automatically update the
         * sum
         * Hint: the code that initializes the text of sumField can be executed again to
         * update the value to reflect
         * the current value
         */
        ActionListener sumListener = (e) -> {
            addend1 = Double.parseDouble(addend1Field.getText());
            addend2 = Double.parseDouble(addend2Field.getText());
            sum = addend1 + addend2;
            sumField.setText(Double.toString(sum));
        };
        addend1Field.addActionListener(sumListener);
        addend2Field.addActionListener(sumListener);
